---
title: "CCL8_CCL13_CombinedAnalysis"
author: "Kelvin Mo"
date: "2024-05-02"
...
ref$predicted_celltype_MI <- ifelse((ref@assays$RNA@counts["CCL13", ] > 0 & ref@assays$RNA@counts["CCL8", ] > 0), "CCL8+CCL13+ Myeloid DC", ref@meta.data$predicted_celltype_MI)

table(ref@meta.data$predicted_celltype_MI)
# B cells       CCL8+CCL13+ Myeloid DC             Myeloid DC                T cells                  Tregs 
#    3711                            2                    757                  10164                   1301
```
...
write_cibersortx_mx <- function(rna, lm22, metadata, metatype = "cell_type",
  ...
  all_ids <- c()
	...
	write.table(cibersortx, file = "scRNAseq-ref-CIBERSORTx-CCL8-CCL13.txt", sep = "\t", quote = FALSE, row.names = TRUE, col.names = NA)
...
write_cibersortx_mx(rna, lm22, metadata = ref@meta.data, metatype = "predicted_celltype_MI")
```
...
# CCL8CCL13+ Myeloid DCs / Total # of Cells
## TCGA-DLBCL
```{r}
cell_fraction <- read.delim("TCGA-DLBCL/CIBERSORTx_Cell-Fractions.txt")
bulk_metadata <- read.delim("../CART-Lymphoma/LBCL/TCGA.DLBC.info.tsv")
...
```{r}
  ...
  median <- median(as.numeric(bulk_metadata[["CCL8"]]))
  bulk_metadata$Expression_Level <- ifelse(as.numeric(bulk_metadata[["CCL8"]]) > median, "High", "Low")
  #low_threshold <- quantile(as.numeric(bulk_metadata[["CCL8"]]), 0.25)
  #high_threshold <- quantile(as.numeric(bulk_metadata[["CCL8"]]), 0.75)
  #bulk_metadata$Expression_Level <- ifelse(as.numeric(bulk_metadata[['CCL8']]) >= high_threshold, "High",
                                            # ifelse(as.numeric(bulk_metadata[['CCL8']]) <= low_threshold, "Low", NA))
  ...
  ggsave(filename=paste0("../KM_CCL8-CCL13_TCGA.png"), p, dpi=600, width=6, height = 6)
  ...
  g$plot <- g$plot + ggtitle(paste("Cox Model of CCL8CCL13 in TCGA")) + annotate("text", x = 2, y = 0.2, label = sprintf("%.3f, %.3f", hr[1], hr_pvalue), size = 4, hjust = "left", vjust = "bottom")
  # Save the plot locally
  ggsave(filename=paste0("../CoxRegression_CCL8CCL13_TCGA.png"), g$plot, width=10, height=6)
...
```{r}
  ...
  p_val <- pchisq(logrank_test$chisq, length(logrank_test$n) - 1, lower.tail = FALSE)
    ...
    # Plot the survival curve
  p <- ggsurvplot(fit, data=bulk_metadata, size=1,  palette=c("#fc0001", "#0000fc"), conf.int=TRUE, pval=FALSE, pval.digits = 4, risk.table=TRUE, risk.table.col = "strata", legend.labs=c("High", "Low"), risk.table.height = 0.20, ggtheme = theme_light(), xlab = "Time (years)", ylab = "Disease-specific survival", conf.int.style = "step", risk.table.title="Number at risk", risk.table.fontsize=3.25) + ggtitle(paste("SurvPlot of CCL8CCL13 cells in TCGA-DLBCL"))
  ...
  # Save the plot locally
  ggsave(filename=paste0("../KM_CCL8-CCL13_TCGA-DFS.png"), p, dpi=600, width=6, height = 6)
  ...
  g$plot <- g$plot + ggtitle(paste("Cox Model of CCL8CCL13 in TCGA")) + annotate("text", x = 2, y = 0.2, label = sprintf("%.3f, %.3f", hr[1], hr_pvalue), size = 4, hjust = "left", vjust = "bottom")
  # Save the plot locally
  ggsave(filename=paste0("../CoxRegression_CCL8CCL13_TCGA-DFS.png"), g$plot, width=10, height=6)
...
```{r}
  ...
  # Save the plot locally
  ggsave(filename=paste0("../KM_CCL8-CCL13_TCGA-DFI.png"), p, dpi=600, width=6, height = 6)
  ...
  g$plot <- g$plot + ggtitle(paste("Cox Model of CCL8CCL13 in TCGA")) + annotate("text", x = 2, y = 0.2, label = sprintf("%.3f, %.3f", hr[1], hr_pvalue), size = 4, hjust = "left", vjust = "bottom")
  # Save the plot locally
  ggsave(filename=paste0("../CoxRegression_CCL8CCL13_TCGA-DFI.png"), g$plot, width=10, height=6)
...
```{r}
  ...
  # Save the plot locally
  ggsave(filename=paste0("../KM_CCL8-CCL13_TCGA-PFI.png"), p, dpi=600, width=6, height = 6)
  ...
  g$plot <- g$plot + ggtitle(paste("Cox Model of CCL8CCL13 in TCGA")) + annotate("text", x = 2, y = 0.2, label = sprintf("%.3f, %.3f", hr[1], hr_pvalue), size = 4, hjust = "left", vjust = "bottom")
  # Save the plot locally
  ggsave(filename=paste0("../CoxRegression_CCL8CCL13_TCGA-PFI.png"), g$plot, width=10, height=6)
...
## GSE34171
```{r}
cell_fraction <- read.delim("KM/GSE34171/CIBERSORTx_Cell-Fractions.txt")
bulk_metadata <- read.delim("../CART-Lymphoma/LBCL/DLBCL.Monti_DLBCL.HGU133A_EntrezCDF.info.tsv")
...
```{r}
  ...
  # Save the plot locally
  ggsave(filename=paste0("../KM_CCL8-CCL13_TCGA-GSE34171.eps"), p, dpi=600, width=4.5, height = 5.5)
  ...
  # Create the survival plot
  g <- ggsurvplot(predicted_survival, xlab="Time (years)", size=1, ylab="Survival Probability", palette="#CC0000", conf.int.style = "step")
  g$plot <- g$plot + ggtitle(paste("Cox Model of CCL8CCL13 in GSE34171")) + annotate("text", x = 2, y = 0.2, label = sprintf("%.3f, %.3f", hr[1], hr_pvalue), size = 4, hjust = "left", vjust = "bottom")
  # Save the plot locally
  #ggsave(filename=paste0("../CoxRegression_CCL8CCL13_GSE34171.eps"), g$plot, width=10, height=6)
...
bulk_metadata <- read.delim("../CART-Lymphoma/LBCL/DLBCL.RCHOP.GSE10846.HGU133Plus2_EntrezCDF.info.tsv")
bulk_metadata <- merge(cell_fraction, bulk_metadata, by.x = "Mixture", by.y = "Array")
head(bulk_metadata)
```
...
```{r}
  ...
  p_val <- pchisq(logrank_test$chisq, length(logrank_test$n) - 1, lower.tail = FALSE)
    ...
    # Plot the survival curve
  p <- ggsurvplot(fit, data=bulk_metadata, size=1,  palette=c("#fc0001", "#0000fc"), conf.int=TRUE, pval=FALSE, pval.digits = 4, risk.table=TRUE, risk.table.col = "strata", legend.labs=c("High", "Low"), risk.table.height = 0.20, ggtheme = theme_light(), xlab = "Time (years)", ylab = "Overall survival", conf.int.style = "step", risk.table.title="Number at risk", risk.table.fontsize=3.25) + ggtitle(paste("SurvPlot of CCL8CCL13 cells in GSE10846-RCHOP"))
  ...
  # Save the plot locally
  ggsave(filename=paste0("../KM_CCL8-CCL13_GSE10846-RCHOP.png"), p, dpi=600, width=6, height = 6)
  ...
  # Create the survival plot
  g <- ggsurvplot(predicted_survival, xlab="Time (years)", size=1, ylab="Survival Probability", palette="#CC0000", conf.int.style = "step")
  g$plot <- g$plot + ggtitle(paste("Cox Model of CCL8CCL13 in GSE10846-RCHOP")) + annotate("text", x = 2, y = 0.2, label = sprintf("%.3f, %.3f", hr[1], hr_pvalue), size = 4, hjust = "left", vjust = "bottom")
  # Save the plot locally
  ggsave(filename=paste0("../CoxRegression_CCL8CCL13_GSE10846-RCHOP.png"), g$plot, width=10, height=6)
...
### GSE10846-CHOP
```{r}
cell_fraction <- read.delim("KM/GSE10846-CHOP/CIBERSORTx_Cell-Fractions.txt")
bulk_metadata <- read.delim("../CART-Lymphoma/LBCL/DLBCL.CHOP.GSE10846.HGU133Plus2_EntrezCDF.info.tsv")
bulk_metadata <- merge(cell_fraction, bulk_metadata, by.x = "Mixture", by.y = "Array")
head(bulk_metadata)
```
...
```{r}
  ...
  median <- median(as.numeric(bulk_metadata[["CCL8"]]))
  bulk_metadata$Expression_Level <- ifelse(as.numeric(bulk_metadata[["CCL8"]]) > median, "High", "Low")
  #low_threshold <- quantile(as.numeric(bulk_metadata[["CCL8"]]), 0.4)
  #high_threshold <- quantile(as.numeric(bulk_metadata[["CCL8"]]), 0.6)
  #bulk_metadata$Expression_Level <- ifelse(as.numeric(bulk_metadata[['CCL8']]) >= high_threshold, "High",
                                            # ifelse(as.numeric(bulk_metadata[['CCL8']]) <= low_threshold, "Low", NA))
  ...
  p_val <- pchisq(logrank_test$chisq, length(logrank_test$n) - 1, lower.tail = FALSE)
    ...
    # Plot the survival curve
  p <- ggsurvplot(fit, data=bulk_metadata, size=1,  palette=c("#fc0001", "#0000fc"), conf.int=TRUE, pval=FALSE, pval.digits = 4, risk.table=TRUE, risk.table.col = "strata", legend.labs=c("High", "Low"), risk.table.height = 0.20, ggtheme = theme_light(), xlab = "Time (years)", ylab = "Overall survival", conf.int.style = "step", risk.table.title="Number at risk", risk.table.fontsize=3.25) + ggtitle(paste("SurvPlot of CCL8CCL13 cells in GSE10846-CHOP"))
  ...
  # Save the plot locally
  ggsave(filename=paste0("../KM_CCL8-CCL13_GSE10846-CHOP.png"), p, dpi=600, width=6, height = 6)
  ...
  # Create the survival plot
  g <- ggsurvplot(predicted_survival, xlab="Time (years)", size=1, ylab="Survival Probability", palette="#CC0000", conf.int.style = "step")
  g$plot <- g$plot + ggtitle(paste("Cox Model of CCL8CCL13 in GSE10846-CHOP")) + annotate("text", x = 2, y = 0.2, label = sprintf("%.3f, %.3f", hr[1], hr_pvalue), size = 4, hjust = "left", vjust = "bottom")
  # Save the plot locally
  ggsave(filename=paste0("../CoxRegression_CCL8CCL13_GSE10846-CHOP.png"), g$plot, width=10, height=6)
...
```{r}
cell_fraction <- read.delim("KM/GSE197977-Baseline/CIBERSORTx_Cell-Fractions.txt")
...
col <- colorRampPalette(c("blue","red"))(4)
  ...
  ex_CR <- bulk_metadata[which(bulk_metadata$Mixture %in% CR), "CCL8"]
  ex_PR <- bulk_metadata[which(bulk_metadata$Mixture %in% PR), "CCL8"]
  ex_SD <- bulk_metadata[which(bulk_metadata$Mixture %in% SD), "CCL8"]
  ex_PD <- bulk_metadata[which(bulk_metadata$Mixture %in% PD), "CCL8"]
  ex_CR_PR <- bulk_metadata[which(bulk_metadata$Mixture %in% CR_PR), "CCL8"]
  ex_SD_PD <- bulk_metadata[which(bulk_metadata$Mixture %in% SD_PD), "CCL8"]
  ...
  g <- ggplot(df_boxplot, aes(x = Response, y = expression, fill=Response)) +
    ...
    labs(y="Propotion of CCL8+CCL13+ Myeloid/DCs", x= "Response") + theme_bw()
  ...
  #ggsave(filename=paste0("../GSE197977_Baseline_CR-PR-SD-PD.png"), g, dpi=300, width=6, height=6)
  
  #ggsave(filename=paste0("../GSE197977_Baseline_CR+PR-SD+PD.png"), g2, dpi=300,width=4, height=6)
  
  ggsave(filename=paste0("../GSE197977_Baseline_CR-PD.eps"), g3, dpi=600,width=4, height=6)
...
```{r}
cell_fraction <- read.delim("KM/GSE153439/CIBERSORTx_Cell-Fractions.txt")
...
```{r}
  ex_DR <- bulk_metadata[which(bulk_metadata$Mixture %in% DR), "CCL8"]
  ex_NDR <- bulk_metadata[which(bulk_metadata$Mixture %in% NDR), "CCL8"]
  ...
  g <- ggplot(df_boxplot, aes(x = Response, y = expression, fill=Response)) +
    ...
    scale_fill_manual(values=c("blue", "red"), labels = labels) + 
    labs(x = "Response", y = "Proportion of CCL8+CCL13+ Myeloid/DCs") +
    theme_bw() 
  ...
  ggsave(filename=paste0("../GSE153439_DR-NDR.eps"), g, width=4, height=6, dpi=600)
...
```{r}
cell_fraction <- read.delim("KM/GSE248835/CIBERSORTx_Cell-Fractions.txt")
...
```{r}
  ...
  p_val <- pchisq(logrank_test$chisq, length(logrank_test$n) - 1, lower.tail = FALSE)
    ...
    # Plot the survival curve
  p <- ggsurvplot(fit, data=bulk_metadata, size=1,  palette=c("#fc0001", "#0000fc"), conf.int=TRUE, pval=FALSE, pval.digits = 4, risk.table=TRUE, risk.table.col = "strata", legend.labs=c("High", "Low"), risk.table.height = 0.20, ggtheme = theme_light(), xlab = "Time (years)", ylab = "Event-free survival", conf.int.style = "step", risk.table.title="Number at risk", risk.table.fontsize=3.25) + ggtitle(paste("SurvPlot of CCL8CCL13 cells in GSE248835"))
  ...
  # Save the plot locally
  ggsave(filename=paste0("../KM_CCL8-CCL13_GSE248835.eps"), p, dpi=600, width=6, height = 6)
  ...
  # Create the survival plot
  g <- ggsurvplot(predicted_survival, xlab="Time (years)", size=1, ylab="Survival Probability", palette="#CC0000", conf.int.style = "step")
  g$plot <- g$plot + ggtitle(paste("Cox Model of CCL8CCL13 in GSE248835")) + annotate("text", x = 2, y = 0.2, label = sprintf("%.3f, %.3f", hr[1], hr_pvalue), size = 4, hjust = "left", vjust = "bottom")
  # Save the plot locally
  #ggsave(filename=paste0("../CoxRegression_CCL8CCL13_GSE248835.png"), g$plot, width=10, height=6)
...
```{r}
  ...
  p_val <- pchisq(logrank_test$chisq, length(logrank_test$n) - 1, lower.tail = FALSE)
    ...
    # Plot the survival curve
  p <- ggsurvplot(fit, data=bulk_metadata, size=1,  palette=c("#fc0001", "#0000fc"), conf.int=TRUE, pval=FALSE, pval.digits = 4, risk.table=TRUE, risk.table.col = "strata", legend.labs=c("High", "Low"), risk.table.height = 0.20, ggtheme = theme_light() + theme(panel.border = element_rect(colour = "black", fill = NA, size = 1)), xlab = "Time (years)", ylab = "Event-free survival", conf.int.style = "step", risk.table.title="Number at risk", risk.table.fontsize=3.25) + ggtitle(paste("SurvPlot of CCL8CCL13 cells in GSE248835"))
  ...
  # Save the plot locally
  ggsave(filename=paste0("../KM_CCL8-CCL13_GSE248835.eps"), p, dpi=600, width=4.5, height = 5.5)
  ...
  g$plot <- g$plot + ggtitle(paste("Cox Model of CCL8CCL13 in GSE248835")) + annotate("text", x = 2, y = 0.2, label = sprintf("%.3f, %.3f", hr[1], hr_pvalue), size = 4, hjust = "left", vjust = "bottom")
  # Save the plot locally
  #ggsave(filename=paste0("../CoxRegression_CCL8CCL13_GSE248835.eps"), g$plot, width=4.5, height=5.5)
...
```{r}
  ...
  # Save the plot locally
  ggsave(filename=paste0("../KM_CCL8-CCL13_GSE248835.png"), p, dpi=600, width=6, height = 6)
...
# CCL8CCL13+ Myeloid DCs / Total # of Myeloid DCs
## TCGA-DLBCL
```{r}
cell_fraction <- read.delim("TCGA-DLBCL/CIBERSORTx_Cell-Fractions.txt")
bulk_metadata <- read.delim("../CART-Lymphoma/LBCL/TCGA.DLBC.info.tsv")
...
### OS
```{r}
  bulk_metadata[["CCL8"]] <- bulk_metadata[["CCL8"]] / (bulk_metadata[["CCL8"]] + bulk_metadata[["Myeloid"]])
...
```{r}
  ...
  g$plot <- g$plot + ggtitle(paste("Cox Model of CCL8CCL13 in GSE34171")) + annotate("text", x = 2, y = 0.2, label = sprintf("%.3f, %.3f", hr[1], hr_pvalue), size = 4, hjust = "left", vjust = "bottom")
  # Save the plot locally
  ggsave(filename=paste0("../CoxRegression_CCL8CCL13_GSE34171.png"), g$plot, width=10, height=6)
...
### GSE10846-CHOP
```{r}
cell_fraction <- read.delim("GSE10846-CHOP/CIBERSORTx_Cell-Fractions.txt")
bulk_metadata <- read.delim("../CART-Lymphoma/LBCL/DLBCL.CHOP.GSE10846.HGU133Plus2_EntrezCDF.info.tsv")
bulk_metadata <- merge(cell_fraction, bulk_metadata, by.x = "Mixture", by.y = "Array")
head(bulk_metadata)
```
...
```{r}
cell_fraction <- read.delim("GSE197977-Baseline/CIBERSORTx_Cell-Fractions.txt")
bulk_metadata <- merge(cell_fraction, df_baseline, by.x = "Mixture", by.y = "geo_accession")
...
col <- colorRampPalette(c("blue","red"))(4)
  ...
  bulk_metadata['GSM5935033', 'CCL8'] <- 1  
  ...
  ggsave(filename=paste0("../GSE197977_Baseline_CR-PD.png"), g3, dpi=300,width=4, height=6)
...
```{r}
  ...
  ggsave(filename=paste0("../GSE153439_DR-NDR.png"), g, width=6, height=6, dpi=600)


  new_data
  
  mean(ex_NDR) / mean(ex_DR)
  mean(ex_DR)
...
```{r}
  ...
  median <- median(as.numeric(bulk_metadata[["CCL8"]]))
  bulk_metadata$Expression_Level <- ifelse(as.numeric(bulk_metadata[["CCL8"]]) > median, "High", "Low")
  #low_threshold <- quantile(as.numeric(bulk_metadata[["CCL8"]]), 0.35)
  #high_threshold <- quantile(as.numeric(bulk_metadata[["CCL8"]]), 0.65)
  #bulk_metadata$Expression_Level <- ifelse(as.numeric(bulk_metadata[['CCL8']]) >= high_threshold, "High", ifelse(as.numeric(bulk_metadata[['CCL8']]) <= low_threshold, "Low", NA))
...
## GSE10846-RCHOP
```{r}
cell_fraction <- read.delim("KM/GSE10846-RCHOP/CIBERSORTx_Cell-Fractions.txt")
bulk_metadata <- read.delim("../CART-Lymphoma/LBCL/DLBCL.RCHOP.GSE10846.HGU133Plus2_EntrezCDF.info.tsv")
bulk_metadata <- merge(cell_fraction, bulk_metadata, by.x = "Mixture", by.y = "Array")
head(bulk_metadata)
```
...
### GSE10846-CHOP
```{r}
cell_fraction2 <- read.delim("KM/GSE10846-CHOP/CIBERSORTx_Cell-Fractions.txt")
bulk_metadata2 <- read.delim("../CART-Lymphoma/LBCL/DLBCL.CHOP.GSE10846.HGU133Plus2_EntrezCDF.info.tsv")
bulk_metadata2 <- merge(cell_fraction2, bulk_metadata2, by.x = "Mixture", by.y = "Array")
head(bulk_metadata2)
```

```{r}
bulk_metadata <- bulk_metadata[,c('CCL8','Myeloid','OS_Status','OS_Time')]
bulk_metadata2 <- bulk_metadata2[,c('CCL8','Myeloid','OS_Status','OS_Time')]
...
```{r}
  ...
  # Save the plot locally
  ggsave(filename=paste0("../KM_CCL8-CCL13_GSE10846.eps"), p, dpi=600, width=4.5, height = 5.5)
...
bulk_metadata3 <- read.delim("../CART-Lymphoma/LBCL/DLBCL.Monti_DLBCL.HGU133A_EntrezCDF.info.tsv")
...
bulk_metadata <- bulk_metadata[,c('CCL8','Myeloid','OS_Status','OS_Time')]
bulk_metadata2 <- bulk_metadata2[,c('CCL8','Myeloid','OS_Status','OS_Time')]
bulk_metadata3 <- bulk_metadata3[,c('CCL8', 'Myeloid', 'OS_Status', 'OS_Time')]
